...
function init() {
	...
	scene.fog = new THREE.Fog( 0x62341b, 2, 15 ); //color de la sombra entre la pared y el piso
	...
	plane.position.y = - 0.5; //posision de las figuras con el suelo
	scene.add( plane );
...
loader.load( '../model/binary/colored.stl', function ( geometry ) {
	...
	if ( geometry.hasColors ) {
		...
		mesh.position.set( 0.5, 0.2, 0 ); // separacion de la figura de palito
		//esta un poco atras de las otras
